...
import { ResourceLinkWithHrefDirective, ResourceViewRegistry } from 'angular-resource-router';
...
const createSpyNavigable = () => jasmine.createSpyObj<Navigable>('navigable', ['go']);
