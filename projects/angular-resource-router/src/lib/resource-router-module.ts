 ...
 */
export const provideLocationStrategy = (platformLocationStrategy: PlatformLocation, baseHref: string, options: ResourceRouterOptions) =>
  options.useHash
 ...
 * @internal
 */
export const emptyView = (): ViewDef => ({
