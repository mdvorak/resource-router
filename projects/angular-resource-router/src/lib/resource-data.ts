...
export class ResourceData implements Navigable, LocationReference {
  ...
  readonly dataChange: Observable<ViewData<any>>;
  ...
  constructor(readonly client: ResourceClient,
              readonly registry: ResourceViewRegistry) {
    // Initialize
...
export const resourceDataNavigableRef = (): FactoryProvider => ({
